        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16">
          ...
          <div className="flex-1 space-y-4 sm:space-y-5 lg:space-y-6">
            <div className="relative">
              <div className="absolute -top-4 -left-4 w-16 sm:w-20 lg:w-24 h-16 sm:h-20 lg:h-24 bg-primary-500/10 rounded-full blur-2xl"></div>
              <h3 className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-3 sm:mb-4 relative">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 mt-6 sm:mt-8">
              {stats.map((stat, index) => (
                <div 
                  key={stat.label}
                  className="bg-white dark:bg-gray-800 rounded-lg sm:rounded-xl p-3 sm:p-4 text-center shadow-lg hover:shadow-xl transition-all duration-300 hover:-translate-y-1"
                >
                  <stat.icon className="w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 text-primary-600 dark:text-primary-400 mx-auto mb-1 sm:mb-2" />
                  <div className="text-base sm:text-lg lg:text-2xl font-bold text-gray-900 dark:text-white">{stat.value}</div>
          ...
          {/* Right Column - Skills */}
          <div className="flex-1 space-y-4 sm:space-y-5 lg:space-y-6 mt-6 lg:mt-0">
            <div className="bg-white dark:bg-gray-800 rounded-xl sm:rounded-2xl shadow-xl p-4 sm:p-6 lg:p-8">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 dark:text-white mb-4 sm:mb-5 lg:mb-6 flex items-center">
                <FiCode className="mr-2 text-primary-600 text-base sm:text-lg lg:text-xl" />
                Core Competencies
              </h3>
                  ...
                  <div key={skill.label} className="group">
                    <div className="flex items-center justify-between mb-1 sm:mb-2">
                      <div className="flex items-center gap-1 sm:gap-2">
                        <skill.icon className="w-3 h-3 sm:w-4 sm:h-4 text-primary-600 dark:text-primary-400" />
            ...
            {/* Philosophy Card */}
            <div className="bg-gradient-to-br from-primary-600 to-purple-600 rounded-xl sm:rounded-2xl p-4 sm:p-6 lg:p-8 text-white">
              <h3 className="text-base sm:text-lg lg:text-xl font-bold mb-3 sm:mb-4">Development Philosophy</h3>
              <ul className="space-y-2 sm:space-y-3">
                <li className="flex items-start gap-2 sm:gap-3">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white/20 flex items-center justify-center mt-0.5 flex-shrink-0">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-white"></div>
                  </div>
                  <span className="text-xs sm:text-sm">Write clean, maintainable code with comprehensive documentation</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white/20 flex items-center justify-center mt-0.5 flex-shrink-0">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-white"></div>
                  </div>
                  <span className="text-xs sm:text-sm">Focus on performance optimization and scalable architecture</span>
                </li>
                <li className="flex items-start gap-2 sm:gap-3">
                  <div className="w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-white/20 flex items-center justify-center mt-0.5 flex-shrink-0">
                    <div className="w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full bg-white"></div>
                  </div>
                  <span className="text-xs sm:text-sm">Prioritize user experience and accessibility in every project</span>
                </li>
              </ul>
            </div>
          </div>
